"""
Django settings for quantum_core project.
...
SECRET_KEY = 'django-insecure-h)=uh5rz=+r747mlwmthp6%m&@)l5e2672@fps%=5jrg_^k8d2'
...
ROOT_URLCONF = 'quantum_core.urls'
...
WSGI_APPLICATION = 'quantum_core.wsgi.application'
...
# settings.py
# Real-World SMTP Email Configuration
